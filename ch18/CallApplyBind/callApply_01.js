...
// `this` 가 바인딩될 객체를 contextObject 로 넘겨준다.
// 그리고 addValues 가 덧셈할 값인 2와 3을 전달한다.

ReliableJavaScript.addValues.call(contextObject, 2, 3); // 결과 5

// addValues 함수를 apply 메서드로 실행한다
// 여기서도 this  가 바인딩될 객체를 contextObject 로 넘겨준다
// 마찬가지로 addValues 가 덧셈할 값 2와 3을 전달한다
