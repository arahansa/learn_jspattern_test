...
describe("Conference.polyfills", function(){
    ...
    describe("arrayForEach(callbackFcn[, thisObj])", function(){
        ...
        describe('thisObj 가 없을 경우', function(){

            it('undefined 를 콘텍스트로 callbackFcn을 실행한다', function(){
                var helper = {
            ...
            it('예정된 인자들을 넘겨 callbackFn을 실행한다', function(){
                var testArray = [{}], callbackSpy = jasmine.createSpy();
        ...
        describe('thisObj가 있을 경우', function(){
            ...
            it('예정된 인자들을 넘겨 callbackFn을 실행한다', function(){
                var thisObj = {}, testArray = [{}], callbackSpy = jasmine.createSpy();
